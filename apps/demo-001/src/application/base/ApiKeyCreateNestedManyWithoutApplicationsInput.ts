...
@InputType()
class ApiKeyCreateNestedManyWithoutApplicationsInput {
...
export { ApiKeyCreateNestedManyWithoutApplicationsInput as ApiKeyCreateNestedManyWithoutApplicationsInput };
