...
@InputType()
class WebhookCreateNestedManyWithoutApplicationsInput {
...
export { WebhookCreateNestedManyWithoutApplicationsInput as WebhookCreateNestedManyWithoutApplicationsInput };
