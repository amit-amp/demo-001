...
@InputType()
class CredentialCreateNestedManyWithoutApplicationsInput {
...
export { CredentialCreateNestedManyWithoutApplicationsInput as CredentialCreateNestedManyWithoutApplicationsInput };
